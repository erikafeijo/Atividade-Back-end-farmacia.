...
import com.farmacia.model.ProdutosModel;
...
public class ProdutoController {
	...
	public ResponseEntity<List<ProdutoModel>> getAll(){
		...
		return ResponseEntity.ok(((Object) produtoRepository).findAll());
	}
	...
	public void delete(@PathVariable Long id) {
		...
		Object produtoRepository;
		Optional<ProdutoModel> produto = ((Object) produtoRepository).findById(id);
